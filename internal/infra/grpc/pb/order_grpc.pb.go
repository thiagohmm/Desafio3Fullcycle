...
type OrderServiceClient interface {
	...
	ListOrder(ctx context.Context, in *Blank, opts ...grpc.CallOption) (*ListOrderRequest, error)
}
...
func (c *orderServiceClient) ListOrder(ctx context.Context, in *Blank, opts ...grpc.CallOption) (*ListOrderRequest, error) {
...
type OrderServiceServer interface {
	...
	ListOrder(context.Context, *Blank) (*ListOrderRequest, error)
...
func (UnimplementedOrderServiceServer) ListOrder(context.Context, *Blank) (*ListOrderRequest, error) {
